...
describe('ambient-occlusion module imports', () => {
  ...
  // engine/testing/import-guards.ts for how the static-vs-type-vs-dynamic import distinction
  // (and its known regex limitation) is made; that helper is shared with the equivalent
  // sky-environment.test.ts guard.
