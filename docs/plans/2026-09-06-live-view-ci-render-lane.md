...
4. **ADR-0171 documents the lane, the probe evidence, and the cost:** about 80 macOS-runner seconds per triggered run, billed at 10x, gated as decision 1 describes.
