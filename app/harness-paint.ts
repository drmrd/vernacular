 ...
 * fixed demo floor and walls, a bare six-hex-digit value paints just the floor with that
 * color, and anything else (including no parameter) leaves paint unset.
 */
