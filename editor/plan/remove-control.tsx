...
export interface RemoveControlProps {
  /** Identifies what this control would remove; a change to it disarms the control. */
  targetId: string
  onConfirm: () => void
}
...
export function RemoveControl({ targetId, onConfirm }: RemoveControlProps): ReactElement {
